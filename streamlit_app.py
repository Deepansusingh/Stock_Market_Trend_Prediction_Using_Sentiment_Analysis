...
if ticker and start_date:
    ...
    if not data.empty:
        ...
        fig = px.line(data, x='Date', y='Close', title=f'{ticker} Stock Price')
        st.plotly_chart(fig, key="initial_price_chart")
        ...
        with pricing_data:
            ...
            data2 = data.copy()
            data2['% Change'] = data['Close'] / data2['Close'].shift(1)
        ...
        with predictions:
            ...
            # Display the fetched data in a line chart
            st.plotly_chart(fig, key="prediction_tab_chart")
